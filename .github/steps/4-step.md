...
### ⌨️ Activity 1: Confirm built-in MCP access

1. Use `/mcp show` or another GitHub-backed prompt to confirm the built-in GitHub MCP server is available in your environment.
...
1. Commit `.mcp.json` and the validation log.
